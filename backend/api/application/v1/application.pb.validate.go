...
// Validate checks the field values on RevokeClientSecretRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *RevokeClientSecretRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on RevokeClientSecretRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// RevokeClientSecretRequestMultiError, or nil if none found.
func (m *RevokeClientSecretRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *RevokeClientSecretRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return RevokeClientSecretRequestMultiError(errors)
	}

	return nil
}

// RevokeClientSecretRequestMultiError is an error wrapping multiple validation
// errors returned by RevokeClientSecretRequest.ValidateAll() if the
// designated constraints aren't met.
type RevokeClientSecretRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m RevokeClientSecretRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m RevokeClientSecretRequestMultiError) AllErrors() []error { return m }

// RevokeClientSecretRequestValidationError is the validation error returned by
// RevokeClientSecretRequest.Validate if the designated constraints aren't met.
type RevokeClientSecretRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e RevokeClientSecretRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e RevokeClientSecretRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e RevokeClientSecretRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e RevokeClientSecretRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e RevokeClientSecretRequestValidationError) ErrorName() string {
	return "RevokeClientSecretRequestValidationError"
}

// Error satisfies the builtin error interface
func (e RevokeClientSecretRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sRevokeClientSecretRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = RevokeClientSecretRequestValidationError{}
...
// Validate checks the field values on ApplicationOverview with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *ApplicationOverview) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ApplicationOverview with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ApplicationOverviewMultiError, or nil if none found.
func (m *ApplicationOverview) ValidateAll() error {
	return m.validate(true)
}

func (m *ApplicationOverview) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.MaskedDescription != nil {
		// no validation rules for MaskedDescription
	}
	...
	if len(errors) > 0 {
		return ApplicationOverviewMultiError(errors)
	}

	return nil
}

// ApplicationOverviewMultiError is an error wrapping multiple validation
// errors returned by ApplicationOverview.ValidateAll() if the designated
// constraints aren't met.
type ApplicationOverviewMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ApplicationOverviewMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ApplicationOverviewMultiError) AllErrors() []error { return m }

// ApplicationOverviewValidationError is the validation error returned by
// ApplicationOverview.Validate if the designated constraints aren't met.
type ApplicationOverviewValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ApplicationOverviewValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ApplicationOverviewValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ApplicationOverviewValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ApplicationOverviewValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ApplicationOverviewValidationError) ErrorName() string {
	return "ApplicationOverviewValidationError"
}

// Error satisfies the builtin error interface
func (e ApplicationOverviewValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sApplicationOverview.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ApplicationOverviewValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ApplicationOverviewValidationError{}

// Validate checks the field values on GetAllReply with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *GetAllReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetAllReply with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in GetAllReplyMultiError, or
// nil if none found.
func (m *GetAllReply) ValidateAll() error {
	return m.validate(true)
}

func (m *GetAllReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetApplicationOverviews() {
		_, _ = idx, item
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GetAllReplyValidationError{
						field:  fmt.Sprintf("ApplicationOverviews[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
			...
			if err := v.Validate(); err != nil {
				return GetAllReplyValidationError{
					field:  fmt.Sprintf("ApplicationOverviews[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return GetAllReplyMultiError(errors)
	}

	return nil
}

// GetAllReplyMultiError is an error wrapping multiple validation errors
// returned by GetAllReply.ValidateAll() if the designated constraints aren't met.
type GetAllReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetAllReplyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetAllReplyMultiError) AllErrors() []error { return m }

// GetAllReplyValidationError is the validation error returned by
// GetAllReply.Validate if the designated constraints aren't met.
type GetAllReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetAllReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetAllReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetAllReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetAllReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetAllReplyValidationError) ErrorName() string { return "GetAllReplyValidationError" }

// Error satisfies the builtin error interface
func (e GetAllReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = GetAllReplyValidationError{}
