...
type AuthenticatorMutation struct {
	...
	kind          *int32
	addkind       *int32
	anchor        **authenticatorNested.Anchor
...
func (m *AuthenticatorMutation) SetAnchor(an *authenticatorNested.Anchor) {
	m.anchor = &an
}

// Anchor returns the value of the "anchor" field in the mutation.
func (m *AuthenticatorMutation) Anchor() (r *authenticatorNested.Anchor, exists bool) {
	v := m.anchor
	if v == nil {
		return
	}
...
// OldAnchor returns the old "anchor" field's value of the Authenticator entity.
// If the Authenticator object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AuthenticatorMutation) OldAnchor(ctx context.Context) (v *authenticatorNested.Anchor, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AuthenticatorMutation) ClearAnchor() {
	m.anchor = nil
	m.clearedFields[authenticator.FieldAnchor] = struct{}{}
}

// AnchorCleared returns if the "anchor" field was cleared in this mutation.
func (m *AuthenticatorMutation) AnchorCleared() bool {
	_, ok := m.clearedFields[authenticator.FieldAnchor]
	return ok
}

// ResetAnchor resets all changes to the "anchor" field.
func (m *AuthenticatorMutation) ResetAnchor() {
	m.anchor = nil
	delete(m.clearedFields, authenticator.FieldAnchor)
}
...
func (m *AuthenticatorMutation) Fields() []string {
	...
	if m.anchor != nil {
		fields = append(fields, authenticator.FieldAnchor)
	}
	return fields
}
...
func (m *AuthenticatorMutation) Field(name string) (ent.Value, bool) {
	...
	case authenticator.FieldKind:
		return m.Kind()
	case authenticator.FieldAnchor:
		return m.Anchor()
	}
	return nil, false
}
...
func (m *AuthenticatorMutation) SetField(name string, value ent.Value) error {
	...
	case authenticator.FieldKind:
		...
		return nil
	case authenticator.FieldAnchor:
		v, ok := value.(*authenticatorNested.Anchor)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
		m.SetAnchor(v)
...
func (m *AuthenticatorMutation) ClearedFields() []string {
	...
	if m.FieldCleared(authenticator.FieldAnchor) {
		fields = append(fields, authenticator.FieldAnchor)
	}
	return fields
}
